...
function crsrAnimation() {
  ...
  var video_crsr=document.querySelector("#video-cursor")
  videoContainer.addEventListener('mouseenter',()=>{
    ...
    videoContainer.addEventListener("click",()=>{
      if(flag===0)
      {
        ...
        video_crsr.innerHTML=`<i class="ri-pause-line"></i>`
        gsap.to("#video-cursor",{
          scale:0.5
        })
        flag=1
        ...
        video_crsr.innerHTML=`<i class="ri-play-mini-fill"></i>`
        gsap.to("#video-cursor",{
          scale:1
        })
        // videoContainer.style.backgroundImage=`https://obys.agency/wp-content/uploads/2022/11/Showreel-2022-preview-1.jpg`
        flag=0
      }
    })
